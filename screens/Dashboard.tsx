...
import { Plus, List, Settings as SettingsIcon, Layers, Bell, Hammer, FolderOpen } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen pb-24 px-6 pt-12">
      <header className="flex justify-between items-center mb-10">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 mb-1">لومینا</h1>
      ...
      >
        <div className="relative z-10 h-full flex flex-col justify-between items-start text-right">
          <div className="p-3 bg-white/10 backdrop-blur-md w-fit rounded-xl text-white">
            <Plus size={24} />
          </div>
          <div>
            <h2 className="text-white text-xl font-bold mb-1">پروژه جدید</h2>
            <p className="text-slate-400 text-sm">محاسبه قیمت و طراحی درب و پنجره</p>
          </div>
        </div>
      ...
      <h3 className="text-slate-800 font-bold mb-4 text-lg">مدیریت قیمت و پروژه‌ها</h3>
      ...
      <div className="grid grid-cols-2 gap-4 mb-8">
        <GlassCard onClick={() => navigate('/profiles')} className="flex flex-col items-center justify-center text-center gap-3 py-6 active:scale-95 transition-transform cursor-pointer">
          ...
          <span className="font-bold text-slate-700 text-sm">قیمت پروفیل</span>
        </GlassCard>
        ...
        <GlassCard onClick={() => navigate('/glass-hardware')} className="flex flex-col items-center justify-center text-center gap-3 py-6 active:scale-95 transition-transform cursor-pointer">
          ...
          <span className="font-bold text-slate-700 text-sm">شیشه و یراق</span>
        </GlassCard>
        ...
        <GlassCard onClick={() => navigate('/projects')} className="flex flex-col items-center justify-center text-center gap-3 py-6 active:scale-95 transition-transform cursor-pointer">
          ...
          <span className="font-bold text-slate-700 text-sm">پروژه‌ها</span>
        </GlassCard>
        ...
        <GlassCard onClick={() => navigate('/settings')} className="flex flex-col items-center justify-center text-center gap-3 py-6 active:scale-95 transition-transform cursor-pointer">
          ...
          <span className="font-bold text-slate-700 text-sm">تنظیمات</span>
        </GlassCard>
      </div>
      ...
      <div className="bg-white/50 backdrop-blur-sm rounded-2xl p-4 border border-white/60 flex items-center justify-between shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <p className="text-sm font-medium text-slate-600">وضعیت سیستم</p>
        </div>
        <span className="text-xs font-bold text-slate-500 bg-slate-100 px-3 py-1 rounded-lg">آنلاین</span>
      </div>
    </div>
  );
};